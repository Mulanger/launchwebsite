...
D:\polywatch-website
  ...
  src/
    ...
    lib/
      ...
      market-pages.js      Server-side market page aggregation from whale feed data.
...
Market pages are not hybrid legacy wrappers. `/market/[slug]` is a native Next server page built from the public whale feed scan. Unknown market slugs return 404. Known but weak markets render with `noindex,follow`; qualified markets become indexable and are included in the dynamic sitemap.
